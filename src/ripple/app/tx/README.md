...
transaction is to be signed outside the Ripple alpha network and only submitted
...
some messaging mechanism outside the Ripple alpha network to disseminate the proposed
...
Currently transactions on the Ripple alpha network require the use of sequence
